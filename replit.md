...
- **Zombie Blanks**: Optional 6 blank "zombie" tiles (default OFF in lobby). When enabled, deck has 158 tiles. Blanks can't form any pattern — they act as dead weight for an extra challenge. Lobby shows info icon tooltip explaining the feature.
